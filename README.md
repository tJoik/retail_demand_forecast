...
В features_import_one_week.ipynb логин и пароль к 1С заменены на заглушки ("***"). Перед реальным запуском (при наличии файловой базы 1С (1c_files/) в корне) необходимо указать логин и пароль, которые доступны только по запросу.
